...
Page({
  ...
  data: {
    ...
    selectBar1: [
      {
        url: '../../index/pages/newwork/newwork',
        src: '/image/index/zhiwei.png',
        text: '最新职位'
      },
      {
        url: '../../index/pages/parttime/parttime',
      ...
      {
        url: '../../index/pages/prog/prog',
        src: '/image/index/pro.png',
        text: '应聘进度'
      },
      {
        url: '../../index/pages/ability/ability',
  ...
  toCompanyDetail: function (e) {
    wx.navigateTo({
      url: '../../index/pages/companyrequest/companyrequest',
    })
  },
  /**
   * 生命周期函数--监听页面初次渲染完成
